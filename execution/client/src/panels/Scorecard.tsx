      ...
      <header className="flex items-baseline justify-between mb-4 gap-4 flex-wrap">
        <div>
          <h2 className="text-lg font-semibold flex items-center">
            Recovery Program Scorecard
            <InfoPopover label="Scorecard methodology">
              <p>
                Synthetix recovery KPIs vs published targets — sourced from the{' '}
                <a
                  href="https://blog.synthetix.io/2026-roadmap/"
              ...
              <p className="mt-2">
                ...
                <span className="text-warn">STUB</span>, paused programs last. Status chips on
                each card indicate which figures are on-chain anchored vs. plausible placeholders
                pending real ETL.
              </p>
            </InfoPopover>
          </h2>
          <p className="text-text-dim text-sm">
            KPIs vs published targets — verified figures first, stubs last.
          </p>
        </div>
